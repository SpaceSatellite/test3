...
for i in column_names:
    ...
    for k in column_names[a:b]:
        ...
        q_part = q_full[column_names.index(k)+1:-column_names.index(k)-1]
            ...
            if diff != flag:
                ...
                if deal_open == 0:
                    ...
                    if flag == 1:
                        ...
                        deal_profit = (deal_close/deal_open)-1
                        deal_clear_profit = (deal_close-deal_open)-(deal_open+deal_close)*commission
                        deal_clear_profit = deal_clear_profit/deal_open
                        deal_kpd = deal_close/deal_high
                        deal_delta_low = 1-(deal_open/deal_low)
                        deal_delta_high = (deal_open/deal_high)-1

                        # print(flag, deal_open, deal_close, deal_profit, deal_clear_profit)
                    else:
                        id_close = id_point
                        deal_close = current_point
                        deal_profit = (deal_open/deal_close)-1
                        deal_clear_profit = (deal_close-deal_open)-(deal_open+deal_close)*commission
                        deal_clear_profit = deal_clear_profit/deal_open
                        deal_kpd = deal_close/deal_low
                        deal_delta_high = (deal_open/deal_low)-1
